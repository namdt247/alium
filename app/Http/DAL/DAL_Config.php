...
class DAL_Config
{
    ...
    const IMAGE_ALIAS_PRODUCT = 'product';
    const IMAGE_ALIAS_ARTICLE = 'article';
    const IMAGE_ALIAS_USER = 'user';
    const IMAGE_ALIAS_SUPPLIER = 'supplier';
    const IMAGE_ALIAS_ORDER = 'order';

    const NUM_PER_PAGE_PRODUCT = 30;
    const NUM_PER_PAGE_USER = 30;
    const NUM_PER_PAGE_ARTICLE = 30;
    const NUM_PER_PAGE_ORDER = 30;
