...
<div class="modal fade" id="registerModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        ...
        <form id="registerForm" method="post" class="content-modal text-left pb-5">
            {!! csrf_field() !!}
            <h2 class="pt-4 header-modal text-center">@lang('message.login.register')</h2>
            ...
            <input type="email" class="form-control mt-4 mb-2" name="email" id="regEmail" required
                   placeholder="@lang('message.question.email')*">
            ...
            <input type="tel" class="form-control mt-4 mb-2" name="phone" id="regPhone" required
                   placeholder="@lang('message.question.phoneNum')*" onkeypress="return keypress(event)"
            ...
            <div class="mt-4 mb-2">
                <select class="city form-control" style="width: 100%;" name="state" id="regState">
            ...
            <input type="password" class="form-control mt-4 mb-2" name="password" id="regPass" required
                   minlength="8" onkeypress="return keypressSpace(event)" onchange="this.value = this.value.trim()"
            ...
            <input type="password" class="form-control mt-4 mb-2" name="password_confirmation"
                   ...
                   onkeypress="return keypressSpace(event)" onchange="this.value = this.value.trim()"
            ...
            <button type="submit" class="btn btn-block btnRegister btn-signin mb-3 py-2">
