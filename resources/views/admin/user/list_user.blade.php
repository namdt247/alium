            ...
            columns: [
                ...
                { data: "user_phone"},
                {
                    ...
                    render: function(data, type, full, meta ){
                        let currentUserRole = "{!! Auth::user()->user_role !!}";
                        let str = '';
                        if(full.user_role > currentUserRole){
                            str += '<i class="fa fa-pencil fa-fw"></i>';
                            str += '<a href="{!! route('admin.user.getEdit',':id') !!}">Chỉnh sửa</a>';
                            str = str.replace(':id', data);
                            str += '<span> | </span>';
                            str += '<i class="fa fa-trash-o fa-fw"></i>';
                            str += '<a href="{!! route('admin.user.getDelete',':id') !!}">Xóa</a>';
                            str = str.replace(':id', data);
                        }
